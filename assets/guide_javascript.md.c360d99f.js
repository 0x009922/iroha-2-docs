...
<span class="line"><span style="color:#24292F;">  EvaluatesToRegistrableBox,</span></span>
...
<span class="line"><span style="color:#24292F;">  MapNameValue,</span></span>
<span class="line"><span style="color:#24292F;">  Metadata,</span></span>
<span class="line"><span style="color:#24292F;">  NewDomain,</span></span>
...
<span class="line"><span style="color:#24292F;">    object: </span><span style="color:#8250DF;">EvaluatesToRegistrableBox</span><span style="color:#24292F;">({</span></span>
...
<span class="line"><span style="color:#24292F;">            </span><span style="color:#0A3069;">&#39;NewDomain&#39;</span><span style="color:#24292F;">,</span></span>
<span class="line"><span style="color:#24292F;">            </span><span style="color:#8250DF;">NewDomain</span><span style="color:#24292F;">({</span></span>
...
<span class="line"><span style="color:#24292F;">    .result.</span><span style="color:#8250DF;">as</span><span style="color:#24292F;">(</span><span style="color:#0A3069;">&#39;Vec&#39;</span><span style="color:#24292F;">)</span></span>
...
<span class="line"><span style="color:#24292F;">  MapNameValue,</span></span>
<span class="line"><span style="color:#24292F;">  Metadata,</span></span>
<span class="line"><span style="color:#24292F;">  Mintable,</span></span>
<span class="line"><span style="color:#24292F;">  RegisterBox,</span></span>
<span class="line"><span style="color:#24292F;">  Value,</span></span>
<span class="line"><span style="color:#24292F;">} </span><span style="color:#CF222E;">from</span><span style="color:#24292F;"> </span><span style="color:#0A3069;">&#39;@iroha2/data-model&#39;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292F;">  }),</span></span>
<span class="line"><span style="color:#24292F;">  metadata: </span><span style="color:#8250DF;">Metadata</span><span style="color:#24292F;">({ map: </span><span style="color:#8250DF;">MapNameValue</span><span style="color:#24292F;">(</span><span style="color:#CF222E;">new</span><span style="color:#24292F;"> </span><span style="color:#0550AE;">Map</span><span style="color:#24292F;">()) }),</span></span>
<span class="line"><span style="color:#24292F;">  mintable: </span><span style="color:#8250DF;">Mintable</span><span style="color:#24292F;">(</span><span style="color:#0A3069;">&#39;Infinitely&#39;</span><span style="color:#24292F;">), </span><span style="color:#6E7781;">// If only we could mint more time.</span></span>
<span class="line"><span style="color:#24292F;">})</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292F;">    }),</span></span>
<span class="line"><span style="color:#24292F;">    destination_id: </span><span style="color:#8250DF;">EvaluatesToRegistrableBox</span><span style="color:#24292F;">({</span></span>
<span class="line"><span style="color:#24292F;">      expression: </span><span style="color:#8250DF;">Expression</span><span style="color:#24292F;">(</span></span>
<span class="line"><span style="color:#24292F;">        </span><span style="color:#0A3069;">&#39;Raw&#39;</span><span style="color:#24292F;">,</span></span>
<span class="line"><span style="color:#24292F;">        </span><span style="color:#8250DF;">Value</span><span style="color:#24292F;">(</span></span>
...
<span class="line"><span style="color:#24292F;">                          map: </span><span style="color:#8250DF;">MapNameValue</span><span style="color:#24292F;">(</span><span style="color:#CF222E;">new</span><span style="color:#24292F;"> </span><span style="color:#0550AE;">Map</span><span style="color:#24292F;">()),</span></span>
<span class="line"><span style="color:#24292F;">                        }),</span></span>
<span class="line"><span style="color:#24292F;">                        logo: </span><span style="color:#8250DF;">OptionIpfsPath</span><span style="color:#24292F;">(</span><span style="color:#0A3069;">&#39;None&#39;</span><span style="color:#24292F;">),</span></span>
<span class="line"><span style="color:#24292F;">                      }),</span></span>
<span class="line"><span style="color:#24292F;">                    ),</span></span>
...
<span class="line"><span style="color:#CF222E;">import</span><span style="color:#24292F;"> {</span></span>
<span class="line"><span style="color:#24292F;">  FilterBox,</span></span>
<span class="line"><span style="color:#24292F;">  OptionHash,</span></span>
<span class="line"><span style="color:#24292F;">  OptionPipelineEntityKind,</span></span>
<span class="line"><span style="color:#24292F;">  OptionPipelineStatusKind,</span></span>
<span class="line"><span style="color:#24292F;">  PipelineEntityKind,</span></span>
<span class="line"><span style="color:#24292F;">  PipelineEventFilter,</span></span>
<span class="line"><span style="color:#24292F;">  PipelineStatusKind,</span></span>
<span class="line"><span style="color:#24292F;">} </span><span style="color:#CF222E;">from</span><span style="color:#24292F;"> </span><span style="color:#0A3069;">&#39;@iroha2/data-model&#39;</span></span>
<span class="line"><span style="color:#CF222E;">import</span><span style="color:#24292F;"> {</span></span>
...
<span class="line"><span style="color:#24292F;">    filter: </span><span style="color:#8250DF;">FilterBox</span><span style="color:#24292F;">(</span></span>
...
<span class="line"><span style="color:#24292F;">        entity_kind: </span><span style="color:#8250DF;">OptionPipelineEntityKind</span><span style="color:#24292F;">(</span></span>
<span class="line"><span style="color:#24292F;">          </span><span style="color:#0A3069;">&#39;Some&#39;</span><span style="color:#24292F;">,</span></span>
<span class="line"><span style="color:#24292F;">          </span><span style="color:#8250DF;">PipelineEntityKind</span><span style="color:#24292F;">(</span><span style="color:#0A3069;">&#39;Transaction&#39;</span><span style="color:#24292F;">),</span></span>
<span class="line"><span style="color:#24292F;">        ),</span></span>
<span class="line"><span style="color:#24292F;">        status_kind: </span><span style="color:#8250DF;">OptionPipelineStatusKind</span><span style="color:#24292F;">(</span></span>
<span class="line"><span style="color:#24292F;">          </span><span style="color:#0A3069;">&#39;Some&#39;</span><span style="color:#24292F;">,</span></span>
<span class="line"><span style="color:#24292F;">          </span><span style="color:#8250DF;">PipelineStatusKind</span><span style="color:#24292F;">(</span><span style="color:#0A3069;">&#39;Committed&#39;</span><span style="color:#24292F;">),</span></span>
<span class="line"><span style="color:#24292F;">        ),</span></span>
...
<span class="line"></span></code></pre></div><p>Here is a small demo with usage of this component:</p><div class="border border-solid border-gray-300 rounded-md shadow-md"><p><img src="`+p+'" alt=""></p></div>',77),t=[e];function c(r,y,i,F,d,u){return a(),n("div",null,t)}var m=s(o,[["render",c]]);export{g as __pageData,m as default};
